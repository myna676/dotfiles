...
vim.keymap.set("n", "<leader>wq", ":close<CR>", opts) -- close current split window
...
vim.keymap.set("n", "<leader>tk", ":tabn<CR>", opts) --  go to next tab
vim.keymap.set("n", "<leader>tj", ":tabp<CR>", opts) --  go to previous tab
...
vim.keymap.set("n", "<leader>dw", vim.diagnostic.goto_next, { desc = "Go to next diagnostic message" })
vim.keymap.set("n", "<leader>dj", vim.diagnostic.open_float, { desc = "Open floating diagnostic message" })
